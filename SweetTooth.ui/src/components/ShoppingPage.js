  ...
  return (
    <>
      <div className="shoppingPage d-flex flex-column justify-content-around mainDiv">
        <Container className = "rounded mb-20 border border-primary">
          <h1>Suggested Snacks (Filtered by Mood)</h1>
        </Container>
        <Container className = "rounded mb-20 border border-secondary flex-grow-1 flex-fill">
          <h1>All Snacks (Filtered by Category</h1>
        </Container>
        <Container className = "rounded mb-20 border border-success">
